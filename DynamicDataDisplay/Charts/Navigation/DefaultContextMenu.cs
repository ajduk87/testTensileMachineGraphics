...
namespace Microsoft.Research.DynamicDataDisplay.Navigation
{
	...
	public class DefaultContextMenu : IPlotterElement
	{
        ...
        //private bool isMouseModeActive = false;

        //public bool IsMouseModeActive
        //{
        //    get { return isMouseModeActive; }
        //    set
        //    {
        //        if (isMouseModeActive != null)
        //        {
        //            isMouseModeActive = value;
        //        }
        //    }
        //}
		...
		protected ContextMenu PopulateContextMenu(IInputElement target)
		{
            ...
            //MenuItem mouseDragDropModeItem = new MenuItem
            //{
            //    //Header = Properties.Resources.ContextMenuQuickHelp,
            //    //ToolTip = Properties.Resources.ContextMenuQuickHelpTooltip,
            //    //Command = ChartCommands.ShowHelp,
            ...
            //    Header = "Uključi mod miša",
            //    ToolTip = "Mod miša je isključen",
            ...
            //staticMenuItems.Add(mouseDragDropModeItem);

			menu.ItemsSource = staticMenuItems;
            //mouseDragDropModeItem.Click += new System.Windows.RoutedEventHandler(this.mouseDragDropMode_Click);


			return menu;
		}

        //private void mouseDragDropMode_Click(object sender, EventArgs e) 
        //{
        //    MenuItem item = (MenuItem)sender;
           
        //    if (IsMouseModeActive == false)
        //    {
        //        IsMouseModeActive = true;
        //        item.Header = "Isključi mod miša";
        //        item.ToolTip = "Mod miša je uključen";
        //    }
        //    else
        //    {
        //        IsMouseModeActive = false;
        //        item.Header = "Uključi mod miša";
        //        item.ToolTip = "Mod miša je isključen";
        //    }
