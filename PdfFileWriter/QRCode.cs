...
public class QRCode
	...
	protected Int32			MaskCode;

	protected Int32			EncodedDataBits;
	protected Int32			matrixDimension;				// Code matrix side in bits
	protected Int32			MaxCodewords;

	protected Int32			MaxDataCodewords;
	protected Int32			MaxDataBits;
	protected Int32			ErrCorrCodewords;
	protected Int32			BlocksGroup1;
	protected Int32			DataCodewordsGroup1;
	protected Int32			BlocksGroup2;
	protected Int32			DataCodewordsGroup2;

	protected String[]		SegDataString;
	protected EncodingMode[] SegEncodingMode;
	protected Byte[]		CodewordsArray;
	protected Int32			CodewordsPtr;
	protected UInt32		BitBuffer;
	protected Int32			BitBufferLen;
	protected Byte[,]		BaseMatrix;
	protected Byte[,]		MaskMatrix;
	protected Byte[,]		ResultMatrix;

	// number of bits on each side of the QR code square
	protected static readonly Byte[]	MatrixDimensionArray =
		{0,
		 21,  25,  29,  33,  37,  41,  45,  49,  53,  57,		// version 1 to 10
		 61,  65,  69,  73,  77,  81,  85,  89,  93,  97,		// version 11 to 20
		101, 105, 109, 113, 117, 121, 125, 129, 133, 137,		// version 21 to 30
		141, 145, 149, 153, 157, 161, 165, 169, 173, 177		// version 31 to 40
		};

	protected static readonly Byte[][] AlignmentPositionArray =
		{
		null,
		null,
		new Byte[] {  6,  18},
	...
	protected static readonly Int16[]	MaxCodewordsArray =
		{0,
	...
	protected static readonly Byte[] DecodingTable =
		{
		(Byte) '0',	// 0
		(Byte) '1',	// 1
		(Byte) '2',	// 2
	...
	protected const Int32 BLOCKS_GROUP1 = 0;
	// B-Number of data codewords in blocks of group 1
	protected const Int32 DATA_CODEWORDS_GROUP1 = 1;
	// C-Number of blocks in group 2
	protected const Int32 BLOCKS_GROUP2 = 2;
	// D-Number of data codewords in blocks of group 2
	protected const Int32 DATA_CODEWORDS_GROUP2 = 3;

	protected static readonly Byte[,] ECBlockInfo = 
			{
			// A,   B,   C,   D 
			{  1,  19,   0,   0},	// 1-L
			{  1,  16,   0,   0},	// 1-M
	...
	protected static readonly Byte[] Generator42 =
	...
	protected static readonly Byte[] Generator44 =
	...
	protected static readonly Byte[] Generator46 =
	...
	protected static readonly Byte[] Generator48 =
	...
	protected static readonly Byte[] Generator50 =
		{ 232, 125, 157, 161, 164,   9, 118,  46, 209,  99, 203, 193,  35,   3, 209, 111,
		  ...
		  133, 205};
	protected static readonly Byte[] Generator52 =
		{ 116,  50,  86, 186,  50, 220, 251,  89, 192,  46,  86, 127, 124,  19, 184, 233,
		  ...
		  239, 254, 116,  51};
	protected static readonly Byte[] Generator54 =
	...
	protected static readonly Byte[] Generator56 =
	...
	protected static readonly Byte[] Generator58 =
	...
	protected static readonly Byte[] Generator60 =
	...
	protected static readonly Byte[] Generator62 =
	...
	protected static readonly Byte[] Generator64 =
	...
	protected static readonly Byte[] Generator66 =
		{   5, 118, 222, 180, 136, 136, 162,  51,  46, 117,  13, 215,  81,  17, 139, 247,
		  ...
		  217,  77,  34, 232, 106,  50, 168,  82,  76, 146,  67, 106, 171,  25, 132,  93,
		   45, 105};
	protected static readonly Byte[] Generator68 =
	...
	protected static readonly Byte[][] GenArray =
	...
	protected static readonly Byte[] ExpToInt = //	ExpToInt =
			{
	...
	protected static readonly Byte[] IntToExp = //	IntToExp =
			{
	...
	public static readonly Int16[] FormatInfoArray =
			{
	...
	protected static readonly SByte[] FormatInfoHor = {-1, -2, -3, -4, -5, -6, -7, -8,  7,  5,  4,  3,  2,  1,  0};
	protected static readonly SByte[] FormatInfoVer = { 0,  1,  2,  3,  4,  5,  7,  8, -7, -6, -5, -4, -3, -2, -1};

	protected static readonly Int32[] VersionInformation =
			{
	...
	public const Byte		NonData = 2;
	public const Byte		Fixed = 4;
	public const Byte		DataWhite =  White;
	public const Byte		DataBlack =  Black;
	public const Byte		FormatWhite =  NonData | White;
	public const Byte		FormatBlack =  NonData | Black;
	public const Byte		FixedWhite =  Fixed | NonData | White;
	public const Byte		FixedBlack =   Fixed | NonData | Black;

	protected static readonly Byte[,]	FinderPatternTopLeft =
		{
	...
	protected static readonly Byte[,]	FinderPatternTopRight =
		{
	...
	protected static readonly Byte[,]	FinderPatternBottomLeft =
		{
	...
	protected static readonly Byte[,]	AlignmentPattern =
		{
	...
	public Int32			MatrixDimension {get{return(matrixDimension);}}
	public ErrorCorrection	ErrorCorrection {get{return(errorCorrection);}}
	...
	protected void SetDataCodewordsLength()
		{
		// index shortcut
		Int32 BlockInfoIndex = (version - 1) * 4 + (Int32) errorCorrection;
		...
		MaxCodewords = MaxCodewordsArray[version];
	...
	protected void BuildBaseMatrix()
		{
		// allocate base matrix
		BaseMatrix = new Byte[MatrixDimension + 5, MatrixDimension + 5];

		// top left finder patterns
		for(Int32 Row = 0; Row < 9; Row++) for(Int32 Col = 0; Col < 9; Col++) BaseMatrix[Row, Col] = FinderPatternTopLeft[Row, Col];

		// top right finder patterns
		Int32 Pos = matrixDimension - 8;
		for(Int32 Row = 0; Row < 9; Row++) for(Int32 Col = 0; Col < 8; Col++) BaseMatrix[Row, Pos + Col] = FinderPatternTopRight[Row, Col];

		// bottom left finder patterns
		for(Int32 Row = 0; Row < 8; Row++) for(Int32 Col = 0; Col < 9; Col++) BaseMatrix[Pos + Row, Col] = FinderPatternBottomLeft[Row, Col];

		// Timing pattern
		for(Int32 Z = 8; Z < matrixDimension - 8; Z++) BaseMatrix[Z, 6] = BaseMatrix[6, Z] = (Z & 1) == 0 ? FixedBlack : FixedWhite;

		// alignment pattern
		if(version > 1)
			{
			Byte[] AlignPos = AlignmentPositionArray[version];
			Int32 AlignmentDimension = AlignPos.Length;
			for(Int32 Row = 0; Row < AlignmentDimension; Row++) for(Int32 Col = 0; Col < AlignmentDimension; Col++)
					{
		...
		if(version >= 7)
			...
			Pos = matrixDimension - 11;

			// top right
			for(Int32 Row = 0; Row < 6; Row++) for(Int32 Col = 0; Col < 3; Col++) BaseMatrix[Row, Pos + Col] = FormatWhite;

			// bottom right
			for(Int32 Col = 0; Col < 6; Col++) for(Int32 Row = 0; Row < 3; Row++) BaseMatrix[Pos + Row, Col] = FormatWhite;
			}
	...
	////////////////////////////////////////////////////////////////////
	// Place alignment pattern square in base matrix
	////////////////////////////////////////////////////////////////////

	protected void PlaceAlignmentPattern
			(
			Int32	PosCol,
			Int32	PosRow
			)
		{
		for(Int32 Row = -2; Row < 3; Row++) for(Int32 Col = -2; Col < 3; Col++)
	...
	protected void ApplyMask0()
		{
		for(Int32 Row = 0; Row < matrixDimension ; Row += 2) for(Int32 Col = 0; Col < matrixDimension; Col += 2)
			{
	...
	protected void ApplyMask1()
		{
		for(Int32 Row = 0; Row < matrixDimension; Row += 2) for(Int32 Col = 0; Col < matrixDimension; Col++)
			if((MaskMatrix[Row, Col] & NonData) == 0) MaskMatrix[Row, Col] ^= 1;
		return;
		}
	...
	protected void ApplyMask2()
		{
		for(Int32 Row = 0; Row < matrixDimension; Row++) for(Int32 Col = 0; Col < matrixDimension; Col += 3)
			if((MaskMatrix[Row, Col] & NonData) == 0) MaskMatrix[Row, Col] ^= 1;
		return;
		}
	...
	protected void ApplyMask3()
		{
		for(Int32 Row = 0; Row < matrixDimension; Row += 3) for(Int32 Col = 0; Col < matrixDimension; Col += 3)
			{
			if((MaskMatrix[Row, Col] & NonData) == 0) MaskMatrix[Row, Col] ^= 1;
	...
	protected void ApplyMask4()
		{
		for(Int32 Row = 0; Row < matrixDimension; Row += 4) for(Int32 Col = 0; Col < matrixDimension; Col += 6)
			{
			if((MaskMatrix[Row, Col] & NonData) == 0) MaskMatrix[Row, Col] ^= 1;
	...
	protected void ApplyMask5()
		{
		for(Int32 Row = 0; Row < matrixDimension; Row += 6) for(Int32 Col = 0; Col < matrixDimension; Col += 6)
			{
			for(Int32 Delta = 0; Delta < 6; Delta++) if((MaskMatrix[Row, Col + Delta] & NonData) == 0) MaskMatrix[Row, Col + Delta] ^= 1;
			for(Int32 Delta = 1; Delta < 6; Delta++) if((MaskMatrix[Row + Delta, Col] & NonData) == 0) MaskMatrix[Row + Delta, Col] ^= 1;
			if((MaskMatrix[Row + 2, Col + 3] & NonData) == 0) MaskMatrix[Row + 2, Col + 3] ^= 1;
	...
	public static void PolynominalDivision(Byte[] Polynomial, Int32 PolyLength, Byte[] Generator, Int32 ErrCorrCodewords)
		{
		Int32 DataCodewords = PolyLength - ErrCorrCodewords;

		// error correction polynomial division
		for(Int32 Index = 0; Index < DataCodewords; Index++)
			{
			...
			for(Int32 GeneratorIndex = 0; GeneratorIndex < ErrCorrCodewords; GeneratorIndex++)
				{
