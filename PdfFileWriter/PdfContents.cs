...
public class PdfContents : PdfObject
	...
	public void TranslateScaleRotate
		...
		{
		ContentsString.AppendFormat(NFI.DecSep, "{2} {3} {4} {5} {0} {1} cm\n",
			ToPt(OrigX), ToPt(OrigY), Round(ScaleX * Math.Cos(Rotate)), Round(ScaleY * Math.Sin(Rotate)), Round(ScaleX * Math.Sin(-Rotate)), Round(ScaleY * Math.Cos(Rotate)));
		return;
		}
	...
	////////////////////////////////////////////////////////////////////
	// Draw web link text with annotation object
	// NOTE:
	...
	public Double DrawWebLink
		...
		{
		return(DrawWebLink(Page, Font, FontSize, TextAbsPosX, TextAbsPosY, TextJustify.Left, DrawStyle.Underline, Color.DarkBlue, Text, WebLink));
		}
	...
	public Int32 DrawText
		...
		{
		return(DrawText(PosX, ref PosYTop, PosYBottom, LineNo, 0.0, 0.0, false, Box, null));
		}
	...
	public Int32 DrawText
		...
		{
		return(DrawText(PosX, ref PosYTop, PosYBottom, LineNo, 0.0, 0.0, false, Box, Page));
		}
	...
	public Int32 DrawText
		...
		{
		return(DrawText(PosX, ref PosYTop, PosYBottom, LineNo, LineExtraSpace, ParagraphExtraSpace, FitTextToWidth, Box, null));
		}
	...
	public Double DrawBarcode
		...
		{
		return(DrawBarcode(PosX, PosY, TextJustify.Left, BarWidth, BarHeight, Color.Black, Barcode, null, 0.0));
		}
	...
	public Double DrawBarcode
		...
		{
		return(DrawBarcode(PosX, PosY, Justify, BarWidth, BarHeight, Color.Black, Barcode, null, 0.0));
		}
	...
	public Double DrawBarcode
		...
		{
		return(DrawBarcode(PosX, PosY, Justify, BarWidth, BarHeight, Color.Black, Barcode, TextFont, FontSize));
		}
	...
	public Double DrawBarcode
			...
			Double		PosX,
			Double		PosY,
			TextJustify	Justify,		// barcode justification
			Double		BarWidth,
			Double		BarHeight,
			Color		BarColor,
			Barcode		Barcode,
	...
	public void DrawQRCode
		...
		// draw QR Code
		ContentsString.AppendFormat(NFI.DecSep, "q {0} 0 0 {0} {1} {2} cm {3} Do Q\n",
			ToPt(Width), ToPt(OrigX), ToPt(OrigY), QRCode.ResourceCode);
		return;
		}
	...
	public void DrawXObject
		...
		{
		SaveGraphicsState();
		TranslateScale(OrigX, OrigY, ScaleX, ScaleY);
		DrawXObject(XObject);
		RestoreGraphicsState();
		return;
		}
	...
	public void DrawXObject
		...
		{
		SaveGraphicsState();
		TranslateScaleRotate(OrigX, OrigY, ScaleX, ScaleY, Alpha);
		DrawXObject(XObject);
		RestoreGraphicsState();
		return;
		}
